...
// --- Ícones SVG embutidos para garantir que funcionem ---
  ...
  return (
    <aside className={styles.sidebarContainer}>
      <div className={styles.logoContainer}>
        <img src="/logo_portal.png" alt="Portal Contábil" className={styles.logo} />
      </div>
      ...
      <div className={styles.footerContainer}>
        <button onClick={handleLogout} className={styles.logoutButton}>
          ...
          <span className={styles.linkText}>Sair da Conta</span>
        </button>
      </div>
    </aside>
  );
